...
function pop(URL)
 {
	window.open(URL,'Transecute','toolbar=no,location=no,directories=no,status=no,menubar=no,scrollbars=no,resizable=no,width=400,height=400,top=100,left=100')
 }
...
oCMenu.offlineUrl="file:///C|/Inetpub/wwwroot/sssct/" //Value: "path_to_menu_file_offline/"
...
oCMenu.onlineUrl="http://www.srisathyasai.org.in" //Value: "path_to_menu_file_online/"
...
oCMenu.barcolor="#ffcc99" //The color of the background bar - Value: "color"
...
oCMenu.barheight="10" //The height of the background bar. Set this to "menu" if you want it to be the same height as the menu. (this will change to match the border if you have one) - Value: px || "%" || "menu"
oCMenu.barx=getX() //The left position of the bar. Set this to "menu" if you want it be the same as the left position of the menu. (this will change to match the border if you have one)  - Value: px || "%" || "menu"
oCMenu.bary=125 //The top position of the bar Set this to "menu" if you want it be the same as the top position of the menu. (this will change to match the border if you have one)  - Value: px || "%" || "menu"
...
oCMenu.fromleft=getX() //This is the left position of the menu. (Only in use if menuplacement below is 0 or aligned) (will change to adapt any borders) - Value: px || "%"
oCMenu.fromtop=125 //This is the left position of the menu. (Only in use if menuplacement below is 0 or aligned) (will change to adapt any borders) - Value: px || "%"
oCMenu.pxbetween=26 //How much space you want between each of the top items. - Value: px || "%"
...
oCMenu.level[0].bgcoloroff="" //The default background color for each level[0] (top) items. You can override this on each item by spesifying the backgroundcolor when making the item. - Value: "color"
oCMenu.level[0].bgcoloron="" //The default "on" background color for each level[0] (top) items. You can override this on each item by spesifying the "on" background color when making the item. - Value: "color"
...
oCMenu.level[0].hovercolor="#0214FE"//The default "on" text color for each level[0] (top) items. You can override this on each item by spesifying the "on" text color when making the item. - Value: "color"
oCMenu.level[0].style="padding:-5px; font-family:arial,tahoma,arial,helvetica; font-size:12px;" //The style for all level[0] (top) items. - Value: "style_settings"
...
oCMenu.level[0].cliptim=5 //This is the speed of the timer for the clip effect. Play with this and the clippx to get the desired speed for the clip effect (be carefull though and try and keep this value as high or possible or you can get problems with NS4). - Value: milliseconds
...
oCMenu.level[1].style="padding:3px; font-family:verdana,tahoma,arial,helvetica; font-size:11px;"
oCMenu.level[1].bgcoloroff="#FCECEB" //The default background color for each level[0] (top) items. You can override this on each item by spesifying the backgroundcolor when making the item. - Value: "color"
oCMenu.level[1].bgcoloron="#F7DAF6" //The default "on" background color for each level[0] (top) items. You can override this on each item by spesifying the "on" background color when making the item. - Value: "color"
oCMenu.level[1].textcolor="#000000" //The default text color for each level[0] (top) items. You can override this on each item by spesifying the text color when making the item. - Value: "color"oCMenu.level[1].width=250
oCMenu.level[1].hovercolor="#262966"
oCMenu.level[1].border=1 //The border size for all level[0] (top) items. - Value: px
oCMenu.level[1].bordercolor="#E1C4C3" //The border color for all level[0] (top) items. - Value: "color"
